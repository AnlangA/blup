...
impl std::fmt::Debug for Config {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("Config")
            ...
            .field("prompts_dir_ok", &!self.prompts_dir.as_os_str().is_empty())
            .field("schemas_dir_ok", &!self.schemas_dir.as_os_str().is_empty())
            .field("data_dir_ok", &!self.data_dir.as_os_str().is_empty())
