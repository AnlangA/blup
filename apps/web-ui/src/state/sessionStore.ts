...
export const useSessionStore = create<SessionStore>((set) => ({
  ...
  codeTheme: (localStorage.getItem('blup_code_theme') as CodeTheme) || 'github-dark',
  ...
  reset: () => {
    ...
    set({ sessionId: null, currentChapterId: null });
  },
}));

// Apply theme on initial load
const initialTheme = (localStorage.getItem('blup_code_theme') as CodeTheme) || 'github-dark';
